...
public class CalculatorParameterizedTest {
    ...
    public static Iterable<Object[]> data() {
        return Arrays.asList(new Object[][]{
                ...
                {new CalculatorOperation("2", CalculatorHelper.DIV, CalculatorHelper.SUB), "incorrect format"},
                {new CalculatorOperation("2", CalculatorHelper.MUL, CalculatorHelper.ADD, "1"), "3"},
    ...
    public CalculatorParameterizedTest(CalculatorOperation operation, String expectedResult) {
